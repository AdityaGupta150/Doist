const isEmpty = (str) => {	//ONLY trims the string, and checks whether it's empty
	if ( str.trim() == '' )
		return true;
	else
		return false;
...
let validateLoginData = (cred) => {
	if( isEmpty(cred.email) || isEmpty(cred.password) ){
		error  = "Please fill both fields first";
	}
